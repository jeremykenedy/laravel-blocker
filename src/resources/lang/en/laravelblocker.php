...
return [
    'ui' => [
        ...
        'description'         => 'Manage the rules that protect your application.',
        'appearance'          => 'Appearance',
        'light'               => 'Light',
        'dark'                => 'Dark',
        'system'              => 'System',
        'navigation'          => 'Blocker navigation',
        'active'              => 'Blocked items',
        'deleted'             => 'Deleted items',
        'create'              => 'Add blocked item',
        'validation'          => 'Check the following fields.',
        'list_help'           => 'Review, edit, and manage blocked entries.',
        'search'              => 'Search',
        'edit'                => 'Edit',
        'delete'              => 'Delete',
        'restore'             => 'Restore',
        'destroy'             => 'Delete permanently',
        'restore_all'         => 'Restore all deleted items',
        'destroy_all'         => 'Permanently delete all deleted items',
        'confirm_delete'      => 'Move this item to deleted items?',
        'confirm_destroy'     => 'Permanently delete this item? This cannot be undone.',
        'confirm_restore'     => 'Restore this blocked item?',
        'confirm_restore_all' => 'Restore every deleted item, including items outside this page or search?',
        'confirm_destroy_all' => 'Permanently delete every deleted item, including items outside this page or search? This cannot be undone.',
        'empty'               => 'No blocked items found.',
        'pagination'          => 'Pagination',
        'previous'            => 'Previous',
        'next'                => 'Next',
        'type'                => 'Type',
        'select_type'         => 'Choose a type',
        'value'               => 'Value',
        'user'                => 'User (optional)',
        'note'                => 'Note',
        'save'                => 'Save item',
