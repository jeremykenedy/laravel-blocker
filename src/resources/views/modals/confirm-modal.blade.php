@php
    ...
    $btnSubmitText = $btnSubmitText ?? trans('laravelblocker::laravelblocker.modals.btnConfirm');
@endphp
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-outline pull-left btn-flat" type="button" data-dismiss="modal">
                    <i class="fa fa-fw fa-close" aria-hidden="true"></i> {{ trans('laravelblocker::laravelblocker.modals.btnCancel') }}
                </button>
